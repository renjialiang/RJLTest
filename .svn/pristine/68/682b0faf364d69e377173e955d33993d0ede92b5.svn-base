...
typedef NS_ENUM(NSUInteger, CTDisplayViewState){
...
@interface CoreTextDisplayView () <UIGestureRecognizerDelegate, UITextViewDelegate>
...
@property (nonatomic, strong) MagnifiterView *magnifierView;
@end
...
- (void)drawRect:(CGRect)rect
{
	...
	for (CoreImageData * imageData in self.data.imageArray) {
