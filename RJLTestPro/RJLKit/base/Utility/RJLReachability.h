...
typedef NS_ENUM(NSUInteger, RJLReachabilityStatus) {
    RJLReachabilityStatusNone = 0, ///< Not Reachable
    RJLReachabilityStatusWWAN = 1, ///< Reachable via WWAN (2G/3G/4G)
    RJLReachabilityStatusWiFi = 2, ///< Reachable via WiFi
};

typedef NS_ENUM(NSUInteger, RJLReachabilityWWANStatus) {
    RJLReachabilityWWANStatusNone = 0, ///< Not Reachable vis WWAN
    RJLReachabilityWWANStatus2G = 2,   ///< Reachable via 2G (GPRS/EDGE)       10~100Kbps
    RJLReachabilityWWANStatus3G = 3,   ///< Reachable via 3G (WCDMA/HSDPA/...) 1~10Mbps
    RJLReachabilityWWANStatus4G = 4,   ///< Reachable via 4G (eHRPD/LTE)       100Mbps
};

/**
 `RJLReachability` can used to monitor the network status of an iOS device.
 */
@interface RJLReachability : NSObject

@property (nonatomic, readonly) SCNetworkReachabilityFlags flags;                           ///< Current flags.
@property (nonatomic, readonly) RJLReachabilityStatus status;                               ///< Current status.
@property (nonatomic, readonly) RJLReachabilityWWANStatus wwanStatus NS_AVAILABLE_IOS(7_0); ///< Current WWAN status.
...
@property (nullable, nonatomic, copy) void (^notifyBlock)(RJLReachability *reachability);
