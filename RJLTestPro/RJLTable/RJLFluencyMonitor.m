...
@implementation RJLFluencyMonitor

static RJLFluencyMonitor *instance = nil;
...
{
	@autoreleasepool {
		[[NSThread currentThread] setName:@"RJLFluencyMonitor"];
...
- (void)startWithInterval:(NSTimeInterval)interval fault:(NSTimeInterval)fault
{
	...
	_observer = CFRunLoopObserverCreate(kCFAllocatorDefault,
										...
										YES,
										0,
										&runLoopObserverMonitorCallBack,
										&context);
...
static void runLoopObserverMonitorCallBack(CFRunLoopObserverRef observer, CFRunLoopActivity activity, void *info){
	RJLFluencyMonitor *monitor = (__bridge RJLFluencyMonitor*)info;
