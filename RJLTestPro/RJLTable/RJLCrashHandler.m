...
@implementation RJLCrashHandler

static RJLCrashHandler *instance = nil;
...
void HandleException(NSException *exception)
{
	...
	RJLCrashHandler *crashObject = [RJLCrashHandler sharedInstance];
...
{
	// 这种情况的崩溃信息，就另某他法来捕获吧
	NSArray *callStack = [RJLCrashHandler backtrace];
